...
def generate_recent_and_history_data(
    ...
    def load_initial_data():
        ...
        with open(data_file, 'r') as csvfile:
            ...
            for row in reader:
                ...
                key, pkey, value = row
                recent_data_dict[pkey] = (key, value, 0, MAX_TIMESTAMP)
        return recent_data_dict

    # Function to process operations and generate recent and history data
    def process_operations(ops_file, recent_data_dict):
        ...
        with open(ops_file, 'r') as csvfile:
            ...
            for row in reader:
                ...
                if op_type == 'insert':
                    ...
                    recent_data_dict[pkey] = (key, value, ts, MAX_TIMESTAMP)
                elif op_type == 'update':
                    if pkey in recent_data_dict:
        ...
        return recent_data_dict, history_data_list
    ...
    recent_data_dict = load_initial_data()
    recent_data_after_txs_dict, history_data_after_txs_list = process_operations(txs_file, recent_data_dict.copy())
    write_data_files(
    ...
    recent_data_dict = load_initial_data()
    recent_data_after_ops_dict, history_data_after_ops_list = process_operations(ops_file, recent_data_dict.copy())
    write_data_files(
