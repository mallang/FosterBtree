...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='Generate data_multiversion for hash join table.',
        formatter_class=argparse.RawTextHelpFormatter
    )
    parser.add_argument(
        '-o', '--output',
        default='./csv/data_multiversion.csv',
        help='Output data file. (default: data_multiversion.csv)'
    )
    parser.add_argument(
        '-n', '--num_records',
        type=int,
    ...
    parser.add_argument(
        ...
        help=(
            ...
            'Defines how many versions will be generated in the dataset.\n'
            '(default: 0)'
        )
    )
